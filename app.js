...
app.post('/selection-personnage', (req, res) => {
  ...
  // En réponse à une sélection de personnage, renvoyez un message de confirmation
...
// Route pour récupérer les données des personnages depuis la base de données
app.get('/personnages', (req, res) => {
  const query = 'SELECT * FROM perso';
